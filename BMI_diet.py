...
#from Frotend.api import Generator
import pickle
#from Frotend.Image.ImageFinder import get_images_links
...
with st.form("recommendation_form"):
    ...
    activity = st.select_slider('Activity',
                                options=['Little/no exercise', 'Light exercise', 'Moderate exercise (3-5 days/wk)',
